...
begin
	...
	if @type like 'Cart�o de Cr�dito' 
		begin
			if @value <= @credit_limit
				...
				begin
					RAISERROR('Limite de cart�o insuficiente para realizar essa transa��o!', 16, 1)
				end
		end
	else
		begin
...
--A��es para as triggers

insert into [transaction] 
values(1, GETDATE(), 'Boleto', 'Pagamento conta energia', 200, 'D') 

insert into [transaction] 
values(2, GETDATE(), 'TED', 'Venciemnto presta��o de servi�o', 200, 'C')

insert into [transaction] 
values(4, GETDATE(), 'Dep�sito', 'Recebimento', 200, 'C')

insert into [transaction]
values(1, GETDATE(), 'Cart�o de Cr�dito', 'Compra', 800, 'D')
